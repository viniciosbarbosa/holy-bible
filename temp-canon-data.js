...
const CANON_DATA_ENGLISH: Phase[] = [
  {
    id: "f0",
    num: "0",
  ...
  },
  {
    ...
    books: [
      ...
      },
      {
        ...
        sub: "Suhrawardi — Fusion of Hermetism, Zoroastrianism, and Islam. Development of the concept of Mundus Imaginalis (Imaginal World).",
        tags: ["ocultismo", "hermetismo"],
  ...
  },
  {
    ...
    theme: "conspiracy",
    div: "MACRO-CONSPIRACIES AND COSMIC GENEALOGY",
    books: [
      ...
      {
        id: "b329_art",
        num: "Le Roi du Monde et les doctrines souterraines",
      ...
      {
        id: "b330_art",
        num: "The Zeta Reticuli Incident: An Astronomical Analysis of the Hill Star Map",
      ...
      {
        id: "b331_art",
        num: "The Reptilian Matrix and the Subversion of Human Sovereignty",
      ...
      {
        id: "b332_art",
        num: "The Lacerta Interview: Transcripts of an Intraterrestrial Entity",
